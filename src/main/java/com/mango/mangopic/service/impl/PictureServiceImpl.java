...
import com.mango.mangopic.manager.FileManager;
import com.mango.mangopic.manager.OssManager;
import com.mango.mangopic.manager.upload.FilePictureUpload;
import com.mango.mangopic.manager.upload.PictureUploadTemplate;
import com.mango.mangopic.manager.upload.UrlPictureUpload;
import com.mango.mangopic.mapper.PictureMapper;
import com.mango.mangopic.model.dto.picture.*;
...
import com.mango.mangopic.model.enums.PictureReviewStatusEnum;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        picture.setThumbnailUrl(uploadPictureResult.getUrl().replaceAll("\\.[^.]+$", ".webp"));
    ...
    public void clearPictureFile(Picture oldPicture) {
        ...
        try{
            ossManager.deleteObject(new URL(oldPicture.getUrl()).getPath().substring(1));
            // 清理缩略图
            String thumbnailUrl = oldPicture.getThumbnailUrl();
            if (StrUtil.isNotBlank(thumbnailUrl)) {
                ossManager.deleteObject(new URL(thumbnailUrl).getPath().substring(1));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
